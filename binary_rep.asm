...
# Cel programu: Program prosi o podanie liczby a nastêpnie zwraca jej binarn¹ reprezentacje
...
addi $t4, $zero, 32 	# wykorzystanie pêtli
loop:

and $t1, $t0, $t3 	# do  t1 wczytaj nasz wynik i przesuñ o 31
beq $t1, $zero, print 	# jeœli t1=0 wyœwietl wartoœæ 0
