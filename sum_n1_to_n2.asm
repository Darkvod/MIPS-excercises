...
# Cel programu: Program prosi o podanie 2 liczb, a nastepnie oblicza sumê od n1 do n2. 
...
beq $t2,$0, wyjscie_z_petli   	# jesli $t2 = 0 (co oznacza ¿e warunek pêtli przesta³ byc spelniony) to wychodzimy z petli
